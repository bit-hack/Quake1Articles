...
!MESSAGE 
!MESSAGE NMAKE /f "zsort.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/zsort.exe $(OUTDIR)/zsort.bsc
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"zsort.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"zsort.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"zsort.bsc" 
BSC32_SBRS= \
	$(INTDIR)/zsort.sbr

$(OUTDIR)/zsort.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"zsort.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"zsort.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/zsort.obj \
	$(INTDIR)/zsort.res

$(OUTDIR)/zsort.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"zsort.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"zsort.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"zsort.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"zsort.bsc" 
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"zsort.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"zsort.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/zsort.obj \
	$(INTDIR)/zsort.res
...
$(INTDIR)/zsort.obj :  $(SOURCE)  $(INTDIR)
...
$(INTDIR)/zsort.res :  $(SOURCE)  $(DEP_ZSORT) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
